...
15. [Appendix: Key Classes Reference](#appendix-key-classes-reference)
...
| `LevelingModule` | `com.livinglands.modules.leveling` | Leveling module |
| `ClaimsModule` | `com.livinglands.modules.claims` | Claims module |
