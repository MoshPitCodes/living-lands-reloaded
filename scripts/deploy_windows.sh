...
if [ ! -f "build/libs/livinglands-1.0.0-beta.jar" ]; then
...
cp build/libs/livinglands-1.0.0-beta.jar "$MODS_DIR/livinglands-1.0.0-beta.jar"

# Verify copy
JAR_SIZE=$(stat -c%s "$MODS_DIR/livinglands-1.0.0-beta.jar")
echo "Deployed: livinglands-1.0.0-beta.jar ($((JAR_SIZE / 1024 / 1024)) MB)"
