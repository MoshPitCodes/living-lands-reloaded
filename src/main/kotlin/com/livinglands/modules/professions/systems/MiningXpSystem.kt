...
class MiningXpSystem(
    ...
    override fun handle(
        ...
        val xpMultiplier = abilityRegistry.getXpMultiplier(playerUuid.toString(), Profession.MINING, currentLevel)
        ...
        if (result.didLevelUp) {
            logger.atInfo().log("Player ${playerUuid} leveled up Mining: ${result.oldLevel} → ${result.newLevel}")
        }
